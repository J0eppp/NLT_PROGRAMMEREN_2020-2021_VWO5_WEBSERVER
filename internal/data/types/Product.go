...
//func (product *Product) SaveToDatabase(db *database.Database) error {
...
//	if db.GetProduct(product.Barcode).Barcode == -1 {
//		// Barcode doesn't exist yet, save it to the database
//		db.Products = append(db.Products, *product)
//		return db.Save()
//	} else {
//		// Barcode does exist already, return nil because there was no error
//		return nil
//	}
